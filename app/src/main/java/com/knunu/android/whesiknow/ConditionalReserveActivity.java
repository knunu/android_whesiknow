...
public class ConditionalReserveActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.image1, R.id.image2, R.id.image3, R.id.image4, R.id.image5, R.id.image6, R.id.image7, R.id.image8, R.id.image9}) void onClickImage(ImageView image) {
        ...
        if (imageBitmap.equals(availableBitmap)) {
            ...
            Toast.makeText(ConditionalReserveActivity.this, "이미 예약된 자리입니다.", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conditional_reserve);
